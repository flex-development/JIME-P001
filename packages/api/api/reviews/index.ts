 ...
 * @param {NumberString} [req.body.id] - ID of product being reviewed
 ...
 * @param {ReviewCuratedStatus} [req.query.curated] - Filter by curation status
 ...
 * @param {string} [req.query.ip_address] - Filter by reviewer IP address
 ...
 * @param {string} [req.query.reviewer_email] - Filter by reviewer email address
 * @param {number} [req.query.reviewer_id] - Filter by reviewer ID
 * @param {ReviewSource} [req.query.source] - Filter by review creation source
