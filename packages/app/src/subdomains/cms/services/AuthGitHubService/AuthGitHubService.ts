...
import { upsertFirebaseUser } from '@app/subdomains/cms/utils/upsertFirebaseUser'
...
} from './IAuthGitHubService'

/**
 * @file Subdomain Services - GitHub Authentication Service
 * @module subdomains/cms/services/AuthGitHubService/impl
 */
...
export default class AuthGitHubService implements IAuthGitHubService {
  ...
  async signIn(
    ...
    await upsertFirebaseUser(id, login, email || undefined, avatar_url)
